...
///         `test/layout/GuardianRegistryLayoutPins.t.sol` and
///         `test/layout/GovernorLayoutPins.t.sol`.
///
...
///         no exceptions.
contract VaultLayoutPinsTest is ProtocolFixture {
    ...
    function setUp() public {
        ...
        // The fixture deploys in this test contract, preserving `_factory`.
        vault = _deployVault(
        ...
        // `test/vault/SyndicateVault.t.sol`'s setUp.
