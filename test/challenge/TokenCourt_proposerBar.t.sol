...
contract ProposerBarTest is TokenCourtTest {
    ...
    function test_proposerCannotVoteItsOwnAcquittal() public {
    ...
    function test_unrelatedVoterIsUnaffected() public {
        uint256 caseId = _disputedWithBond(1_000e18);
    ...
    function test_proposerCannotVoteGuiltyEither() public {
        uint256 caseId = _disputedWithBond(1_000e18);
    ...
    ///         accidental hole.
    function test_zeroBondLeavesTheProposerUnbarred() public {
    ...
    function test_codelessEscrowStillRefers() public {
        game.setChallenge(
            CHALLENGE_ID,
            governor,
            PROPOSAL_ID,
    ...
    function test_shortReturnEscrowStillRefers() public {
        game.setChallenge(
            CHALLENGE_ID,
            governor,
            PROPOSAL_ID,
    ...
    function test_pinSurvivesTheEscrowRecordBeingCleared() public {
        uint256 caseId = _disputedWithBond(1_000e18);
