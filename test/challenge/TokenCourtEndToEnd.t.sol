...
contract TokenCourtEndToEndTest is ProtocolFixture {
    // ── Real stack ──
    ...
    function setUp() public {
        ...
        _wireChallengeGame(owner, ledgerOwner, swood, ledger, tierRegistry, game);
        _wireTokenCourt(owner, swood, game, court);
    ...
    ///         `test/challenge/ChallengeGame.t.sol`'s `test_resolve_forfeitIsProRataToContributionAndLeavesNoDust`,
    ...
    ///         `test_refer_clockCheckBoundary`, test/challenge/TokenCourt.t.sol, for the
    ...
    function test_arc_timeoutRace_bothOrderings() public {
        ...
        // test/challenge/TokenCourt.t.sol, both of which reach it on a challenge that
    ...
    function test_revertingRefer_leavesNoPoisonAndAnyoneCanReferAFreshChallenge() public {
        ...
        // arithmetic to `test_refer_clockCheckBoundary`, test/challenge/TokenCourt.t.sol):
