...
library Logger {
    ...
    event LogInt(int256 p0);

    function logInt(int256 p0) internal {
        emit LogInt(p0);
    }

    event LogUint(uint256 p0);
    ...
    event Log(address p0, uint256 p1);
    ...
    event Log(uint256 p0, uint256 p1, uint256 p2);

    function log(uint256 p0, uint256 p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, uint256 p1, string p2);

    function log(uint256 p0, uint256 p1, string memory p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, uint256 p1, bool p2);

    function log(uint256 p0, uint256 p1, bool p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, uint256 p1, address p2);

    function log(uint256 p0, uint256 p1, address p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, string p1, uint256 p2);

    function log(uint256 p0, string memory p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, string p1, string p2);

    function log(uint256 p0, string memory p1, string memory p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, string p1, bool p2);

    function log(uint256 p0, string memory p1, bool p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, string p1, address p2);

    function log(uint256 p0, string memory p1, address p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, bool p1, uint256 p2);

    function log(uint256 p0, bool p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, bool p1, string p2);

    function log(uint256 p0, bool p1, string memory p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, bool p1, bool p2);

    function log(uint256 p0, bool p1, bool p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, bool p1, address p2);

    function log(uint256 p0, bool p1, address p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, address p1, uint256 p2);

    function log(uint256 p0, address p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, address p1, string p2);

    function log(uint256 p0, address p1, string memory p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, address p1, bool p2);

    function log(uint256 p0, address p1, bool p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(uint256 p0, address p1, address p2);

    function log(uint256 p0, address p1, address p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(string p0, uint256 p1, uint256 p2);

    function log(string memory p0, uint256 p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(string p0, uint256 p1, string p2);

    function log(string memory p0, uint256 p1, string memory p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(string p0, uint256 p1, bool p2);

    function log(string memory p0, uint256 p1, bool p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(string p0, uint256 p1, address p2);

    function log(string memory p0, uint256 p1, address p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(string p0, string p1, uint256 p2);

    function log(string memory p0, string memory p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
    ...
    event Log(string p0, bool p1, uint256 p2);

    function log(string memory p0, bool p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
    ...
    event Log(string p0, address p1, uint256 p2);

    function log(string memory p0, address p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
    ...
    event Log(bool p0, uint256 p1, uint256 p2);

    function log(bool p0, uint256 p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(bool p0, uint256 p1, string p2);

    function log(bool p0, uint256 p1, string memory p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(bool p0, uint256 p1, bool p2);

    function log(bool p0, uint256 p1, bool p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(bool p0, uint256 p1, address p2);

    function log(bool p0, uint256 p1, address p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(bool p0, string p1, uint256 p2);

    function log(bool p0, string memory p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
    ...
    event Log(bool p0, bool p1, uint256 p2);

    function log(bool p0, bool p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
    ...
    event Log(bool p0, address p1, uint256 p2);

    function log(bool p0, address p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
    ...
    event Log(address p0, uint256 p1, uint256 p2);

    function log(address p0, uint256 p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(address p0, uint256 p1, string p2);

    function log(address p0, uint256 p1, string memory p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(address p0, uint256 p1, bool p2);

    function log(address p0, uint256 p1, bool p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(address p0, uint256 p1, address p2);

    function log(address p0, uint256 p1, address p2) internal {
        emit Log(p0, p1, p2);
    }

    event Log(address p0, string p1, uint256 p2);

    function log(address p0, string memory p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
    ...
    event Log(address p0, bool p1, uint256 p2);

    function log(address p0, bool p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
    ...
    event Log(address p0, address p1, uint256 p2);

    function log(address p0, address p1, uint256 p2) internal {
        emit Log(p0, p1, p2);
    }
