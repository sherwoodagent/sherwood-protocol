...
contract MockSwood {
    ...
    ///      file (that is `test/guardian/ExposureLedger_anchorAndRetire.t.sol`'s
...
contract GovernorCoverageGatesTest is ProtocolFixture {
    ...
    ///      (`test/layout/GovernorLayoutPins.t.sol`). Used only to fabricate
