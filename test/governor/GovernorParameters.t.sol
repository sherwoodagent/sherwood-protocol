...
contract GovernorParametersTest is ProtocolFixture {
    ...
    // `mgmtSplit` / `perfSplit`, covered by test/vault/fees/ProtocolConfigSplits.t.sol.
    ...
    // covered by test/vault/fees/ProtocolConfigSplits.t.sol.
