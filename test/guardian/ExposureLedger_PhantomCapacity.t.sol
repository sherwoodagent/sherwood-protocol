...
///         both.
contract ExposureLedgerPhantomCapacityTest is ExposureLedgerTest {
    ...
    ///         hand budget back.
    function test_secondLockIsRefusedWhileTheFirstIsLive() public {
        _wireAttack();
    ...
    function test_capacityIsReleasedOnceTheFirstLockExpires() public {
        _wireAttack();
