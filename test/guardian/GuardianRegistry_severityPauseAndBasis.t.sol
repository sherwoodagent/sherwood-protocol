...
contract GuardianRegistry_severityPauseAndBasisTest is RegistryTestHarness {
    ...
    function test_severityUsesAtOpenEnvelope_notLiveSlots() public {
    ...
    function test_blockQuorumTalliesRawStake_notAgedWeight() public {
        vm.prank(regOwner);
    ...
    function test_repeatedPauseCyclesCompound() public {
        _stakeGuardian(approver1, 30_000e18, 1);
    ...
    function test_pauseDefersReviewWindow_ratherThanClearingIt() public {
        _stakeGuardian(approver1, 30_000e18, 1);
        _stakeGuardian(blocker1, 20_000e18, 2);
