...
contract VaultWithdrawalQueueTest is Test {
    ...
    function test_depositCancelStaysOpenBecauseTheOptionIsWorthless() public {
    ...
    function test_depositCancelStillOpenBeforeAnySettlementSinceRequest() public {
    ...
    function test_redeemCancelStillGatesOnItsOwnPid() public {
        uint256 pidOther = PID + 1;
