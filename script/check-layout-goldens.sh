...
# only thing separating two structs that share a bare name (`BatchExecutorLib.Call`
# vs any other `Call`); stripping the id would collapse both onto `t_struct(Call)_storage`.
#
