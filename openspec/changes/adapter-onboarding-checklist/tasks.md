...
- [ ] 1. Recon: read `src/TierRegistry.sol` (certify, setAdapterAllowed,
...
- [ ] 2. Write `docs/adapter-onboarding-checklist.md` per the spec delta.
- [ ] 3. Verify docs-only diff; `git diff --name-only origin/main...HEAD`
  shows no compiler inputs.
- [ ] 4. Commit on `docs/adapter-onboarding-checklist`, push, open PR
