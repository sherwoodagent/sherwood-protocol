...
interface IRequestableVault {
    ...
    ///         deposit claim below refuses on this, same as the instant path.
    function depositsLocked() external view returns (bool);
    /// @notice Live assets-to-shares for a MINT at the current price; the
    ///         deposit claim prices against this rather than a frozen stamp.
